                ...
                <div class="p-6 text-gray-900">
                    <section class="bg-white dark:bg-gray-900">
                        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                            ...
                            <p class="mb-4 text-lg font-extrabold leading-none text-gray-900 md:text-xl dark:text-white">Rp. {{ number_format($product->price, 0, ',', '.') }}</p>
                            <dl>
                            ...
                            <dl class="">
                                <div>
                                    <dt class="mt-7 font-semibold leading-none text-gray-900 dark:text-white">Konselor</dt>
