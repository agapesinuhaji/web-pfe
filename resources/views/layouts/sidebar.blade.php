        ...
        <ul class="space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              ...
              <li>
                <ahref= href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" >Kanban</a>
              </li>
              <li>
                <ahref= href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" >Calendar</a >
              </li>
            </ul>
          </li>
