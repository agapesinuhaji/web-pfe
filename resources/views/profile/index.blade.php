...
<head>
  ...
  <title>My Profile - Psychologist For Everyone</title>
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="date_of_birth" class="block mb-2 text-sm font-medium text-gray-900">Tanggal Lahir</label>
                            <input type="date" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $user->profile->date_of_birth) }}" class="w-full p-2.5 border rounded-lg bg-gray-50 text-gray-900">
                        </div>

                        <!-- Tambahan: Jenis Kelamin -->
                        <div>
                            <label for="gender" class="block mb-2 text-sm font-medium text-gray-900">Jenis Kelamin</label>
                            <select name="gender" id="gender" class="w-full p-2.5 border rounded-lg bg-gray-50 text-gray-900">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="file" name="image" id="image" accept="image/*" class="w-full text-sm text-gray-900 border rounded-lg cursor-pointer bg-gray-50">
