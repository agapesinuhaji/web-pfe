  ...
  <header class="absolute inset-x-0 top-0 z-50 ">
    <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8 ">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="#" class="text-sm/6 font-semibold text-gray-700">Log in <span aria-hidden="true">&rarr;</span></a>
      </div>
    </nav>
    <el-dialog>
    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pt-4 lg:pr-8">
        <div class="lg:max-w-lg">
          <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl">Mengapa memilih PFE?</p>
      ...
      <img width="2432" height="1442" src="img/conseling-1.png" alt="Product screenshot" class="w-3xl max-w-none sm:w-228 md:-ml-4 lg:-ml-0" />
    </div>
  </div>
</div>
...
<footer class="p-4 bg-gray-900 md:p-8 lg:p-10 ">
  <div class="mx-auto max-w-screen-xl text-center">
      ...
      <span class="text-sm text-gray-100 sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">PFE™</a>. All Rights Reserved.</span>
  </div>
</footer>
