...
<head>
    ...
    <title>Register - Psychologist For Everyone</title>
...
<body>
    ...
    <section class="bg-gray-50 dark:bg-gray-900  bg-gradient-to-br from-white via-pink-200 to-blue-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="/" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-8 h-8 mr-2" src="{{ asset('favicon.svg') }}" alt="logo">
              ...
              <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
                @csrf
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Already registered?? <a href="/login" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign in</a>
                  </p>
              </form>
          </div>
      </div>
