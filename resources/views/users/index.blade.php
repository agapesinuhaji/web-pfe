                                    ...
                                    <div class="w-full md:w-1/2">
                                        <form class="flex items-center">
                                            ...
                                            <div class="relative w-full">
                                                ...
                                                <input type="text" id="simple-search" class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @forelse ($users as $user)
                                                <tr class="border-b dark:border-gray-700">
                                                    ...
                                                    <td class="px-4 py-3">
                                                        <img src="{{ asset('storage/' . $user->profile->image) }}" alt="{{ $user->profile->name }}" class="w-10 h-10 rounded-full shadow object-cover ring-2 ring-gray-300 dark:ring-gray-500">
                                                    </td>
                                                    ...
                                                    <td class="px-4 py-3 flex items-center justify-end">
                                                        ...
                                                        <div id="user-{{ $user->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                            <ul class="py-1 text-sm" aria-labelledby="user-{{ $user->id }}-dropdown-button">
                                                                <li>
                                                                    <a href="{{ route('user.edit', $user) }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
